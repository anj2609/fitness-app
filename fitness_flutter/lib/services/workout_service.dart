  ...
  static List<Workout> getWorkouts() {
    return [
      Workout(
        ...
        description: 'A comprehensive workout targeting all major muscle groups. Perfect for building overall strength and endurance.',
        duration: 30,
        exerciseCount: 8,
      ...
      Workout(
        ...
        exercises: [
          Exercise(
            id: '4',
            name: 'Pull-ups',
            description: 'An excellent exercise for back and biceps development.',
            sets: 4,
            reps: 8,
            duration: 60,
          ...
          Exercise(
            id: '5',
            name: 'Dumbbell Press',
            description: 'Build chest and shoulder strength with this compound movement.',
            sets: 4,
            reps: 10,
            duration: 45,
          ...
          Exercise(
            id: '6',
            name: 'Tricep Dips',
            description: 'Isolate and strengthen the triceps with this bodyweight exercise.',
            sets: 3,
            reps: 12,
            duration: 45,
      ...
      Workout(
        ...
        exercises: [
          ...
          Exercise(
            id: '9',
            name: 'Leg Raises',
            description: 'Target lower abs and hip flexors with this challenging exercise.',
            sets: 3,
            reps: 12,
            duration: 45,
